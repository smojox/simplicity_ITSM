...
import { connectToDatabase, UserModel, OrganizationModel } from '@simplicity/db'
import GoogleProvider from 'next-auth/providers/google'
import EmailProvider from 'next-auth/providers/email'
import type { User, Organization } from '@simplicity/types'
  ...
  callbacks: {
    ...
    async signIn({ user, account, profile }) {
      ...
      try {
        ...
        if (!existingUser) {
          // For new users, create a new organization if they don't have one
